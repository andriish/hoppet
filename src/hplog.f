...
C      write(11,'(' 'g [H(' ',)', advance = 'no' ) 
C      call subprint(11,na) 
C      write(11,'('','',)', advance = 'no' ) 
C      call subprint(11,nb) 
C      write(11,'('',y)] = H('',)', advance = 'no' ) 
C      call subprint(11,na) 
C      write(11,'('','',)', advance = 'no' ) 
C      call subprint(11,nb) 
C      write(11,'('',y) ; '')') 

C      write(12,'(''id H('',)', advance = 'no' ) 
C      call subprint(12,na) 
C      write(12,'('','',)', advance = 'no' ) 
C      call subprint(12,nb) 
C      write(12,'('',y) = H[('',)', advance = 'no' ) 
C      call subprint(12,na) 
C      write(12,'('','',)', advance = 'no' ) 
C      call subprint(12,nb) 
C      write(12,'('',y)] ; '')') 
